...
- Управление конфигурацией, редактирование и обновление
- Детекция клавиатуры и пресеты для известных конфигов, добавленых автором 
- Возможность подцепить layouts в системе (например, в macOS они не всегда обозначаются как ru/en)
- Конфигурация автоматически формируется на основе доступных подключенных устройств
