...
{{< callout icon="sparkles" >}}
  Со слов автора: "Это форк, практически без изменений основного кода, просто обертка на Swift, чтобы отображать иконку в трее и дать возможность на лету обновлять конфиг
{{< /callout >}}
