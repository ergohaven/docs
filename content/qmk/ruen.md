...
Для **macOS** доступна [сборка](https://github.com/VlaDi4eKK/qmk-hid-host/releases) от автора VlaDi4eKK, это обертка на Swift, чтобы отображать иконку в трее и дать возможность на лету обновлять конфиг.
