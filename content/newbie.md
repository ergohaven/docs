---
title: Введение в мир сплит-клавиатур
---

## Введение

Эта статья создана для тех, кто только открывает для себя мир эргономичных сплит-клавиатур. Здесь вы узнаете, почему традиционная клавиатура не является физиологически оптимальным инструментом, познакомитесь с ключевыми понятиями и характеристиками сплитов, а также получите практические рекомендации по выбору первого устройства. Если вы хотите работать за компьютером комфортнее и дольше — читайте дальше.

---

## Эргономика

Кисти рук человека устроены так, что в расслабленном состоянии они развёрнуты наружу примерно на 10–15 градусов относительно оси предплечья. Стандартная клавиатура игнорирует эту особенность: она заставляет разворачивать запястья внутрь, чтобы пальцы легли на клавиши. Такое положение называется локтевым отведением и при длительном воздействии приводит к усталости и боли.

Разделённая на две независимые половинки клавиатура позволяет расположить каждую из них точно под углом, соответствующим положению рук, — запястья остаются прямыми. Это снижает нагрузку на сухожилия и мышцы-сгибатели предплечья.

Стандартная клавиатура также вынуждает сводить локти вместе, что сужает плечевой пояс и создаёт постоянное напряжение в трапециевидных мышцах. Сплит позволяет развести половинки на ширину плеч — плечи расправляются, нагрузка на шею и верхний отдел спины уменьшается.

Колончатый стаггер (column stagger) — ещё одна ключевая особенность эргономичных клавиатур. На традиционной клавиатуре ряды клавиш смещены горизонтально — это наследие печатной машинки, продиктованное механическими ограничениями. Пальцы у человека двигаются вертикально, а не по диагонали, поэтому колончатое расположение значительно сокращает путь каждого пальца до клавиши и снижает риск травм от повторяющихся движений.
...
{{< tabs >}}
  {{< tab name="Линейные" >}}
Нажатие плавное, без тактильного щелчка. Подходят для быстрого набора текста и игр. Тихие варианты (silent) практически не слышны.

**Примеры:** Gateron Red, Gateron Yellow, Akko CS Penguin
  {{< /tab >}}
  {{< tab name="Тактильные" >}}
В момент срабатывания ощущается лёгкий «бамп» — тактильный отклик. Помогают чувствовать момент регистрации нажатия без звукового сигнала. Популярный выбор для офиса и работы с текстом.

**Примеры:** Gateron Brown, Akko CS Jelly Pink, Boba U4
  {{< /tab >}}
  {{< tab name="Кликовые" >}}
Тактильный отклик сопровождается отчётливым щелчком. Обеспечивают максимальную обратную связь, однако шумны — подходят не для всех рабочих мест.

**Примеры:** Gateron Blue, Kailh Box White
  {{< /tab >}}
{{< /tabs >}}
...
Профиль — это форма и высота кейкапа. Наиболее распространённые:

- **Cherry** — умеренная высота, слегка наклоненные ряды. Универсальный выбор.
- **OEM** — чуть выше Cherry, часто идут в базовых комплектах.
- **XDA / DSA** — низкие, сферические, одинаковые на всех рядах. Удобны на сплитах, где нет привычного деления на ряды.
- **MCC** — низкий профиль, хорошо сочетается с изогнутыми корпусами.
{{< /details >}}

{{< details title="Материалы" >}}
- **ABS** — стандартный пластик, доступный по цене. Со временем становится глянцевым (шайнинг).
- **PBT** — более твёрдый и долговечный, не блестит при длительном использовании. Предпочтительный выбор для постоянного использования.
{{< /details >}}
...
{{< tabs >}}
  {{< tab name="Проводное (USB-C)" >}}
Половинки соединяются между собой кабелем TRRS или USB-C, одна из них подключается к компьютеру. Минимальная задержка, не требует зарядки.

Прошивка: **QMK**. Настройка: **Vial**.
  {{< /tab >}}
  {{< tab name="Беспроводное (Bluetooth)" >}}
...
Прошивка: **ZMK**. Настройка: **Keymap Editor** (веб-браузер).
  {{< /tab >}}
{{< /tabs >}}
...
|----------|--------------|----------------------|
| QMK | Vial (десктоп) | Все проводные модели Ergohaven |
| ZMK | Keymap Editor (веб) | Все беспроводные модели Ergohaven |
...
- **Не для всех задач.** В ситуациях, требующих быстрого переключения между несколькими людьми за одним компьютером, использование личной раскладки может создать неудобство для других.
...
### Шаг 4: не торопитесь с кейкапами

Все клавиатуры Ergohaven поставляются с кейкапами в комплекте. На первом этапе этого достаточно. Замена кейкапов — дело вкуса, которое решается позже, когда вы уже освоитесь с раскладкой.
