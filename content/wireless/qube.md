...
1. Для подключения дополнительного устройства необходимо перевести тип подключения на беспроводной при помощи кнопки  OUT BLE и активировать на клавиатуре желаемый номер профиля (3 слой в раскладке по умолчанию)
2. На дополнительном устройстве находим клавиатуру в списке Bluetooth устройств и подключаемся к ней
3. Для возврата на проводное подключение переключитесь на него при помощи кнопки  OUT USB (3 слой в раскладке по умолчанию)
