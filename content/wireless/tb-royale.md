...
![image](/layouts/tb_royale_ru.png)


**Trackball Royale** - беспроводное эргономичное устройство для управления курсором, с четыремя программируемыми клавишиами. Форма корпуса трекбола спроектирована для более естественного положения руки, что помогает снизить нагрузку при длительной работе за компьютером. Корпус трекбола изготовлен по технологии высокоточной SLA-печати.
...
<details>
<summary>Проводное подключение</summary>
...
<details>
<summary>Беспроводное подключение</summary>
...
<details>
<summary>Подключение дополнительных устройств</summary>
...
## Зарядка трекбола, мониторинг заряда

[Зарядка и мониторинг заряда](https://docs.ergohaven.xyz/zmk/zmk-keyboards/#%d0%b7%d0%b0%d1%80%d1%8f%d0%b4%d0%ba%d0%b0-%d0%b1%d0%b0%d1%82%d0%b0%d1%80%d0%b5%d0%b8) происходят аналогично беспроводным клавиатурам на ZMK
...
Прошивка требуется случаях, когда:
...
### Алгоритм прошивки трекбола 
1. Скачайте актуальные файлы прошивок *settings_reset* и *Trackball Royal* с [keymap_hub](https://github.com/ergohaven/keymap_hub)
2. Подключите USB-C кабелем устройство с прошивкой (ПК, ноутбук и т.п.) и трекбол, дважды нажмите кнопку Reset с обратной стороны трекбола
3. Трекбол перейдёт в режим загрузчика и откроется папка-хранилище (если на вашем устройстве отключен автозапуск подключаемых дисков, то перейдите в папку-хранилище вручную)
4. Скопируйте или перетащите Uf2 файл *settings_reset*, после чего трекбол должен моментально перезагрузиться
>Settings_reset прошивка нужна для затирания внутренней памяти трекбола. Она сбрасывает настройки профилей подключения
5. Снова дважды нажмите кнопку Reset с обратной стороны трекбола и дождитесь когда он перейдёт в режим загрузчика (откроется папка-хранилище)
6. Скопируйте или перетащите Uf2 файл прошивки для *Trackball Royal*, после чего трекбол должен моментально перезагрузиться

Прошивка завершена, можно подключать трекбол к вашему устройству!э

## Уход и обслуживание

- Периодически очищайте корпус от пыли и загрязнений сухой или влажной тканной салфеткой
>Использование спиртосодержащих растворов, ацетона, бензина, растворителей (646, уайт-спирит), концентрированных кислот и щелочей крайне не рекомендуется, так как эти растворы могут повредить сам корпус и лаковое покрытие
